...
@Name(CompletableFutureUniCompletionCreateEvent.NAME)
@Category({ NEW_RELIC_JFR_EVENT, SUPPORTABILITY, TRANSACTION, COMPLETABLE_FUTURE })
@Label("CompletableFuture$UniCompletion Created")
@Description("CompletableFuture instrumentation info")
@StackTrace(true)
public class CompletableFutureUniCompletionCreateEvent extends Event {
    static final String NAME = NR_NAMESPACE_PREFIX + "CompletableFutureUniCompletionCreate";

    @Label("Transaction Object")
    public String transactionObject;

    @Label("CompletableFuture$UniCompletion Object")
    public String uniCompletionObject;
