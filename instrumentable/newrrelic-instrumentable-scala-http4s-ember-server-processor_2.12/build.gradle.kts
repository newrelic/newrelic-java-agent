...
crossBuild {
    scalaVersionsCatalog = mapOf("2.12" to "2.12.13")
    builds {
        register("scala") {
            scalaVersions = HashSet<String>().also { it.add("2.12") }
        }
    }
}
...
dependencies {
    ...
    implementation("org.http4s:http4s-ember-server_2.12:0.23.12")
...
mapOf("2.12" to crossBuildScala_212Jar).forEach { (scalaVersion, versionedClassJar) ->
