            ...
            if (shouldCreateLogEvent(message, throwable)) {
                ...
                if (message != null) {
                    ...
                    if (formattedMessage != null && !formattedMessage.isEmpty()) {
                        logEventMap.put(AppLoggingUtils.MESSAGE, formattedMessage);
                    }
                }
                logEventMap.put(AppLoggingUtils.TIMESTAMP, event.getTimeMillis());
                ...
                logEventMap.put(AppLoggingUtils.THREAD_ID, event.getThreadId());
