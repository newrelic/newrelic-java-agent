# apache-sling-htl-2.0.6

This module is for injecting the browser monitoring header script into Apache [Sling](https://sling.apache.org/) 
[HTL](https://sling.apache.org/documentation/bundles/scripting/scripting-htl.html) templates. HTL is the engine
utilized by Adobe Experience Manager (AEM).

Note that this module targets Apache Sling 2.0.6 through 3.0.0 (exclusive). This version range targets the
`javax` namespace.

### Module Application
The module instruments the base interface of `javax.servlet.ServletResponse`. In order to prevent this from
