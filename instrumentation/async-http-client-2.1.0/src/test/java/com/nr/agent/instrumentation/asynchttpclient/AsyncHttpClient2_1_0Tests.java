...
@Category({ Java11IncompatibleTest.class, Java17IncompatibleTest.class, Java21IncompatibleTest.class, Java25IncompatibleTest.class, Java27IncompatibleTest.class })
...
public class AsyncHttpClient2_1_0Tests {
    ...
    public void testCat() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.asynchttpclient.AsyncHttpClient2_1_0Tests/makeAsyncRequest";
        ...
        assertEquals(1, MetricsHelper.getScopedMetricCount(txName,
                "Java/com.nr.agent.instrumentation.asynchttpclient.AsyncHttpClient2_1_0Tests/makeAsyncRequest"));
