...
import static llm.models.ModelInvocation.*;
...
public class Llama2ModelInvocation implements ModelInvocation {
    Map<String, String> linkingMetadata;
    Map<String, Object> userAttributes;
    ModelRequest modelRequest;
    ModelResponse modelResponse;

    public Llama2ModelInvocation(Map<String, String> linkingMetadata, Map<String, Object> userCustomAttributes, InvokeModelRequest invokeModelRequest,
            InvokeModelResponse invokeModelResponse) {
        this.linkingMetadata = linkingMetadata;
        this.userAttributes = userCustomAttributes;
        this.modelRequest = new Llama2ModelRequest(invokeModelRequest);
        this.modelResponse = new Llama2ModelResponse(invokeModelResponse);
    }
