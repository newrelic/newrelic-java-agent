...
abstract class SessionManager_Instrumentation {
    ...
    public ResultSetFuture executeAsync(Statement statement) {
        ...
        if (result != null && null != AgentBridge.getAgent().getTransaction(false)
        ...
        if (segment != null) {
            NewRelicChainedResultSetFuture nrfuture =
                    new NewRelicChainedResultSetFuture(getLoggedKeyspace(), segment, result, statement);
