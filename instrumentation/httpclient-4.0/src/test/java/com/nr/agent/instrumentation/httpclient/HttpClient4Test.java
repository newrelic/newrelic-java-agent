...
public class HttpClient4Test {
    ...
    public void testCat() throws Exception {
        ...
        assertEquals(1, MetricsHelper.getScopedMetricCount(txName,
                "Java/com.nr.agent.instrumentation.httpclient.HttpClient4Test/httpClientExternal"));
    ...
    public void externalRequest(URI endpoint) throws IOException {
        ...
        final HttpHost httpHost = new HttpHost(endpoint.getHost(), endpoint.getPort(), endpoint.getScheme());
