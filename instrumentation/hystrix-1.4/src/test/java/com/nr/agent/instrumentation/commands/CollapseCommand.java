...
public class CollapseCommand extends HystrixCollapser<List<String>, String, Integer> {

    private final Integer key;

    public CollapseCommand(Integer key) {
        this.key = key;
    }
    ...
    private static final class BatchCommand extends HystrixCommand<List<String>> {
        ...
        private BatchCommand(Collection<CollapsedRequest<String, Integer>> requests) {
            super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("ExampleGroup")).andCommandKey(
                    HystrixCommandKey.Factory.asKey("GetValueForKey")).andCommandPropertiesDefaults(
