 ...
 * JakartaWsRsApi_Instrumentation will grab both path annotations and add them to the transaction name.
 *
 * Case 2: Class annotation = @Path, method annotation = @GET, subresource method annotation = @Path
 * JakartaWsRsApi_Instrumentation annotation will grab the class path and JakartaWsRsApi_SubResource_Instrumentation will grab the subresource path.
 *
...
public class JakartaWsRsApi_Subresource_Instrumentation {
    ...
    @WeaveWithAnnotation(annotationClasses = { "jakarta.ws.rs.PUT", "jakarta.ws.rs.POST", "jakarta.ws.rs.GET",
            "jakarta.ws.rs.DELETE", "jakarta.ws.rs.HEAD", "jakarta.ws.rs.OPTIONS", "jakarta.ws.rs.Path", "jakarta.ws.rs.PATCH" })
    @WeaveIntoAllMethods
