...
public abstract class Connection {
    ...
    protected Connection sendCommand(final Protocol.Command cmd, final byte[]... args) {
        try {
            ...
            instrument(NewRelic.getAgent().getTracedMethod(), cmd, getHost(), getPort());
        }
    }
    ...
    private void instrument(TracedMethod method, Protocol.Command command, String serverUsed, int serverPortUsed) {
