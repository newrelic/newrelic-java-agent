...
package com.nr.agent.instrumentation.jerseyclient3;
...
public class JerseyClient3Test {
    ...
    public void testError() {
        ...
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.jerseyclient3.JerseyClient3Test/makeExternalRequest";
    ...
    public void testHttpMethods() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.jerseyclient3.JerseyClient3Test/requestHttpMethods";
    ...
    public void testAsync() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.jerseyclient3.JerseyClient3Test/requestHttpMethodsAsync";
    ...
    public void testAsyncCallback() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.jerseyclient3.JerseyClient3Test/requestHttpMethodsAsyncCallback";
        assertEquals(1, introspector.getFinishedTransactionCount(2000));
        Collection<String> names = introspector.getTransactionNames();
        assertTrue(names.contains(txName));
    ...
    public void testCat() throws Exception {
        ...
        assertEquals(1, MetricsHelper.getScopedMetricCount(txName,
                "Java/com.nr.agent.instrumentation.jerseyclient3.JerseyClient3Test/makeExternalRequest"));
