...
public final class ClusterIdHelper {
    ...
    // value on every invocation, so a producer whose metadata hasn't finished its first
    // refresh yet keeps retrying the actual read, just without re-walking the class
