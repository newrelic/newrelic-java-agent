...
public class SinkTaskInstrumentationTest {

    @Test
    public void pollTest() throws InterruptedException {
        startTx();
        Introspector introspector = InstrumentationTestRunner.getIntrospector();
        String transactionName = "OtherTransaction/Custom/org.apache.kafka.connect.sink.SinkTaskInstrumentationTest/startTx";
        ...
        assertEquals("Java/com.nr.agent.instrumentation.target.NoopSinkTask/put", traceSegment.getName());
        ...
        assertTrue(metricsForTransaction.containsKey("Java/com.nr.agent.instrumentation.target.NoopSinkTask/put"));
    ...
    private void startTx() throws InterruptedException {
        SinkTask sinkTask = new NoopSinkTask();
        sinkTask.put(emptyList());
    }
}