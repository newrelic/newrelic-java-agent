...
public class NRDelayCancellableContinuation<T> implements CancellableContinuation<T> {
    ...
    @Override
    public @Nullable <R extends T> Object tryResume(R r, @Nullable Object o,@Nullable Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3) {
        if(segment != null) {
            segment.end();
            segment = null;
        }
        return delegate.tryResume(r,o,function3);
    }
