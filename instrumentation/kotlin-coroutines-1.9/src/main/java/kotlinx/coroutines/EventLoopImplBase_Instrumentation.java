...
public abstract class EventLoopImplBase_Instrumentation {
        ...
        static class DelayedResumeTask_Instrumntation extends DelayedTask_Instrumentation {


                public DelayedResumeTask_Instrumntation(long nanos, kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit> cont) {
                        super(nanos);
                }
        ...
        static class DelayedRunnableTask_Instrumntation extends DelayedTask_Instrumentation {

                public DelayedRunnableTask_Instrumntation(long nanos, Runnable r) {
                        super(nanos);
                }
