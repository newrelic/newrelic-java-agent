...
public class ApplicationResponseFunctionsKt_Instrumentation {
    ...
    @Trace
    public static Object respondText(ApplicationCall call, ContentType contentType, HttpStatusCode status, Function1<? super Continuation<? super String>, ?> function1, Continuation<? super Unit> continuation) {
        KtorExtendedResponse extendedResponse = new KtorExtendedResponse(call);
        NewRelic.getAgent().getTransaction().setWebResponse(extendedResponse);
        return Weaver.callOriginal();
    }
    ...
    @Trace
    public static Object respondBytes(ApplicationCall call, ContentType contentType, HttpStatusCode status, Function1<? super Continuation<? super byte[]>, ?> function1, Continuation<? super Unit> continuation) {
        KtorExtendedResponse extendedResponse = new KtorExtendedResponse(call);
        NewRelic.getAgent().getTransaction().setWebResponse(extendedResponse);
        return Weaver.callOriginal();
    }
    ...
    @Trace
    public static Object respondBytesWriter(ApplicationCall call, ContentType contentType, HttpStatusCode status, Long contentLength, kotlin.jvm.functions.Function2<? super io.ktor.utils.io.ByteWriteChannel, ? super Continuation<? super Unit>, ?> function2, Continuation<? super Unit> continuation) {
        KtorExtendedResponse extendedResponse = new KtorExtendedResponse(call);
        NewRelic.getAgent().getTransaction().setWebResponse(extendedResponse);
        return Weaver.callOriginal();
    }
