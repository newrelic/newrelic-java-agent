# Lettuce 6.5 Instrumentation

This module instruments the Lettuce Redis client starting with version 6.5.0. It provides comprehensive monitoring for synchronous, asynchronous, and reactive Redis operations.
...
2. **Command Instrumentation** - Redis commands retrieve the stored URI from the connection to create datastore metrics and report externals. 
