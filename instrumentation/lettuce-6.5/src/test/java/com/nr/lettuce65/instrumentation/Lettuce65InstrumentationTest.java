...
import com.nr.lettuce65.instrumentation.helper.Data;
import com.nr.lettuce65.instrumentation.helper.RedisDataService;
...
public class Lettuce65InstrumentationTest {
    ...
    public void testSync() {
        ...
        String setTransactionName = BASE_TXN_NAME + "/syncSet";
        String getTransactionName = BASE_TXN_NAME + "/syncGet";
    ...
    public void testAsync() throws ExecutionException, InterruptedException {
        ...
        String setTransactionName = BASE_TXN_NAME + "/asyncSet";
        String getTransactionName = BASE_TXN_NAME + "/asyncGet";
    ...
    public void testReactive() {
        ...
        String setTransactionName = BASE_TXN_NAME + "/reactiveSet";
        String getTransactionName = BASE_TXN_NAME + "/reactiveGet";
