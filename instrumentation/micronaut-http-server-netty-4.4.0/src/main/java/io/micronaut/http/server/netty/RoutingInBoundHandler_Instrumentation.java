...
import com.nr.agent.instrumentation.micronaut.netty_44.NettyExtendedRequest;
import com.nr.agent.instrumentation.micronaut.netty_44.NettyHeaders;
...
public abstract class RoutingInBoundHandler_Instrumentation {
    ...
    @Trace(async = true)
    public void accept(ChannelHandlerContext_Instrumentation ctx, io.netty.handler.codec.http.HttpRequest request, ByteBody body,
