...
abstract class DBCollectionImpl extends DBCollection {
    ...
    @Trace(leaf = true)
    protected WriteResult updateImpl(DBObject q, DBObject o, boolean upsert, boolean multi, WriteConcern concern,
    ...
    abstract BulkWriteResult executeBulkWriteOperation(final boolean ordered, final Boolean bypassDocumentValidation,
            final List<WriteRequest> requests, final WriteConcern writeConcern, final DBEncoder encoder);
