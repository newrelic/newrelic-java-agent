...
public abstract class MongoDatabase_Weaved {
    ...
    public MongoCollection_Instrumentation<Document> getCollection(final String collectionName) {
        MongoCollection_Instrumentation<Document> collection = Weaver.callOriginal();
