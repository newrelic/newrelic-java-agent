...
abstract class MongoCollectionImpl_Instrumentation<TDocument> implements MongoCollection<TDocument> {
    ...
    MongoCollectionImpl_Instrumentation(final MongoNamespace namespace, final Class<TDocument> documentClass, final CodecRegistry codecRegistry,
            final ReadPreference readPreference, final WriteConcern writeConcern, final boolean retryWrites,
            final ReadConcern readConcern, final AsyncOperationExecutor_Instrumentation executor) {
