 ...
 * Adapted from https://mongodb.github.io/mongo-java-driver/3.6/driver-async/getting-started/quick-start/
 */
public class MongoDbAsyncQuickStart {
    ...
    public void run() {
        ...
        // Contributes 2 to value of Datastore/operation/MongoDB/find
