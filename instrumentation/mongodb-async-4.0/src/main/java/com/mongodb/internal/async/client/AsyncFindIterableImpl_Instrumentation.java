...
@Weave(type = MatchType.ExactClass, originalName = "com/mongodb/internal/async/client/AsyncFindIterableImpl")
abstract class AsyncFindIterableImpl_Instrumentation<TDocument, TResult> extends AsyncMongoIterableImpl_Instrumentation<TResult> {

    AsyncFindIterableImpl_Instrumentation(@Nullable final AsyncClientSession clientSession, final MongoNamespace namespace,
