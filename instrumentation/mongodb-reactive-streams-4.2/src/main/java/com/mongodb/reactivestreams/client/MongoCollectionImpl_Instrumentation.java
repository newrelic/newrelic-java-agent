...
class MongoCollectionImpl_Instrumentation<T> {
    ...
    public <T> FindPublisher<T> find(final Bson filter, final Class<T> clazz) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_FIND);
    ...
    public <T> AggregatePublisher<T> aggregate(final List<? extends Bson> pipeline, final Class<T> clazz) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_AGGREGATE);
        return Weaver.callOriginal();
    ...
    public Publisher<InsertOneResult> insertOne(final T document, final InsertOneOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_INSERT_ONE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<InsertManyResult> insertMany(final List<? extends T> documents, final InsertManyOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_INSERT_MANY);
        return Weaver.callOriginal();
    ...
    public Publisher<DeleteResult> deleteOne(final Bson filter, final DeleteOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_DELETE_ONE);
        return Weaver.callOriginal();
    ...
    public Publisher<DeleteResult> deleteMany(final Bson filter, final DeleteOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_DELETE_MANY);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<UpdateResult> replaceOne(final Bson filter, final T replacement, final ReplaceOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_REPLACE_ONE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<UpdateResult> updateOne(final Bson filter, final Bson update, final UpdateOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_UPDATE_ONE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<UpdateResult> updateMany(final Bson filter, final Bson update, final UpdateOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_UPDATE_MANY);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<T> findOneAndDelete(final Bson filter, final FindOneAndDeleteOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_FIND_ONE_AND_DELETE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<T> findOneAndReplace(final Bson filter, final T replacement, final FindOneAndReplaceOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_FIND_ONE_AND_REPLACE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<T> findOneAndUpdate(final Bson filter, final Bson update, final FindOneAndUpdateOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_FIND_ONE_AND_UPDATE);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<Void> drop() {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_DROP_COLLECTION);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<String> createIndex(final Bson key, final IndexOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_CREATE_INDEX);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<String> createIndexes(final List<IndexModel> indexes, final CreateIndexOptions createIndexOptions) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_CREATE_INDEXES);
        return Weaver.callOriginal();
    }
    ...
    @Trace(leaf = true)
    public <T> ListIndexesPublisher<T> listIndexes(final Class<T> clazz) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_LIST_INDEXES);
        return Weaver.callOriginal();
    }

    @Trace(leaf = true)
    public <T> ListIndexesPublisher<T> listIndexes(final ClientSession clientSession, final Class<T> clazz) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_LIST_INDEXES);
        return Weaver.callOriginal();
    ...
    public Publisher<Void> dropIndex(final String indexName, final DropIndexOptions dropIndexOptions) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_DROP_INDEX);
        return Weaver.callOriginal();
    }
    ...
    public Publisher<Void> renameCollection(final MongoNamespace newCollectionNamespace, final RenameCollectionOptions options) {
        NewRelic.getAgent().getTracedMethod().setMetricName(CUSTOM, "AsyncMongoCollection", OP_RENAME_COLLECTION);
        return Weaver.callOriginal();
    }
