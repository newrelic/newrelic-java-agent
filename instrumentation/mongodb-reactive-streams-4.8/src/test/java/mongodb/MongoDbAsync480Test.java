...
public class MongoDbAsync480Test {
    ...
    public void testCollectionApi() throws Throwable {
        ...
        int countOpExpectedCount = 0; // count is covered by aggregate - no longer testing or tracing this call
        ...
        int totalOpCount = insertOpExpectedCount + insertOneOpExpectedCount + insertManyOpExpectedCount + createIndexesOpExpectedCount + updateOpExpectedCount +
                updateManyOpExpectedCount +
