...
public class NingAsyncHttpClient11Tests {
    @ClassRule
    ...
    public void testCat() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.asynchttpclient.NingAsyncHttpClient11Tests/makeAsyncRequest";
        assertEquals(2, introspector.getFinishedTransactionCount(10000));
        ...
        assertEquals(1, MetricsHelper.getScopedMetricCount(txName,
                "Java/com.nr.agent.instrumentation.asynchttpclient.NingAsyncHttpClient11Tests/makeAsyncRequest"));
