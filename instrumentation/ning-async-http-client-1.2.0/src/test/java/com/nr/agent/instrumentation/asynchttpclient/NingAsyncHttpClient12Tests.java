...
public class NingAsyncHttpClient12Tests {
    @ClassRule
    ...
    public void testCat() throws Exception {
        ...
        // transaction
        String txName = "OtherTransaction/Custom/com.nr.agent.instrumentation.asynchttpclient.NingAsyncHttpClient12Tests/makeAsyncRequest";
        ...
        assertEquals(1, MetricsHelper.getScopedMetricCount(txName,
                "Java/com.nr.agent.instrumentation.asynchttpclient.NingAsyncHttpClient12Tests/makeAsyncRequest"));
