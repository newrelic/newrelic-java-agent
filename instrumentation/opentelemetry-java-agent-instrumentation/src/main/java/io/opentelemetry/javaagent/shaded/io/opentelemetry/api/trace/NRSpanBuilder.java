...
//import com.newrelic.api.agent.com.nr.agent.instrumentation.header.utils.HeaderType;
...
// */
//public class NRSpanBuilder implements SpanBuilder {
...
//
//    public NRSpanBuilder(Instrumentation instrumentation, String instrumentationScopeName, String instrumentationScopeVersion,
//            TracerSharedStateWrapper tracerSharedStateWrapper,
//            String spanName) {
...
//        }
//        SpanProcessor activeSpanProcessor = tracerSharedStateWrapper.getActiveSpanProcessor();
//        if (activeSpanProcessor.isEndRequired()) {
//            endHandler = activeSpanProcessor::onEnd;
//        } else {
//            endHandler = span -> {
//            };
//        }
//    }
//
//    public static boolean isSpanBuilderEnabled(Config config) {
...
//        return onStart(new ExitTracerSpan(tracer, instrumentationLibraryInfo, spanKind, spanName, parentSpanContext, tracerSharedStateWrapper.getResource(), attributes,
//                endHandler));
//    }
//
...
//
//            @Override
//            public com.nr.agent.instrumentation.header.utils.HeaderType getHeaderType() {
//                return com.nr.agent.instrumentation.header.utils.HeaderType.HTTP;
//            }
//
//            @Override
...
//                parentSpanContext, tracerSharedStateWrapper.getResource(), attributes, endHandler));
//    }
//
//     // error: incompatible types: io.opentelemetry.sdk.trace.ReadWriteSpan cannot be converted to io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span
//     //        return span;
//    Span onStart(ReadWriteSpan span) {
//        // FIXME
//        Context parent = Context.current();
//        if (tracerSharedStateWrapper.getActiveSpanProcessor().isStartRequired()) {
//            tracerSharedStateWrapper.getActiveSpanProcessor().onStart(parent, span);
//        }
//        return span;
//    }
//
