...
////    private final io.opentelemetry.api.trace.SpanKind spanKind;
...
////    private final io.opentelemetry.api.trace.SpanContext parentSpanContext;
...
//
//    ExitTracerSpan(Object tracer, Object instrumentationLibraryInfo, Object spanKind, Object spanName, Object parentSpanContext,
...
////        this.spanContext = io.opentelemetry.api.trace.SpanContext.create(tracer.getTraceId(), tracer.getSpanId(), io.opentelemetry.api.trace.TraceFlags.getDefault(), io.opentelemetry.api.trace.TraceState.getDefault());
...
//    }
//}
////public class ExitTracerSpan implements io.opentelemetry.sdk.trace.ReadWriteSpan {
////    static final String OTEL_LIBRARY_VERSION = "otel.library.version";
////    static final AttributeKey<String> OTEL_LIBRARY_NAME = AttributeKey.stringKey("otel.library.name");
////    private static final AttributeKey<String> DB_SYSTEM = AttributeKey.stringKey("db.system");
////    private static final AttributeKey<String> DB_STATEMENT = AttributeKey.stringKey("db.statement");
...
////    private final Resource resource;
////
////    ExitTracerSpan(ExitTracer tracer, InstrumentationLibraryInfo instrumentationLibraryInfo, io.opentelemetry.api.trace.SpanKind spanKind, String spanName, io.opentelemetry.api.trace.SpanContext parentSpanContext,
////            Resource resource, Map<String, Object> attributes, Consumer<ExitTracerSpan> onEnd) {
////        this.tracer = tracer;
////        this.spanKind = spanKind;
////        this.spanName = spanName;
...
////        return new ExitTracerSpan(tracer, InstrumentationLibraryInfo.empty(), io.opentelemetry.api.trace.SpanKind.INTERNAL, tracer.getMetricName(), io.opentelemetry.api.trace.SpanContext.getInvalid(),
////                Resource.empty(), Collections.emptyMap(), span -> {
////        });
////    }
////
///// /    public static ImplicitContextKeyed wrap(ExitTracer tracer) {
///// /        return new ExitTracerSpan(tracer, InstrumentationLibraryInfo.empty(), io.opentelemetry.api.trace.SpanKind.INTERNAL, tracer.getMetricName(), io.opentelemetry.api.trace.SpanContext.getInvalid(),
///// /                Resource.empty(), Collections.emptyMap(), span -> {
///// /        });
///// /    }
...
////
//////    @Override
//////    public <T> Span setAttribute(io.opentelemetry.javaagent.shaded.io.opentelemetry.api.common.AttributeKey<T> attributeKey, T t) {
//////        // FIXME this or the previous one?
//////        attributes.put(attributeKey.getKey(), t);
//////        return null;
//////    }
////
////    @Override
////    public <T> io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span setAttribute(io.opentelemetry.javaagent.shaded.io.opentelemetry.api.common.AttributeKey<T> attributeKey, T t) {
////        attributes.put(attributeKey.getKey(), t);
////        return this;
////    }
////
////    @Override
////    public io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span addEvent(String name, Attributes attributes) {
////        return this;
////    }
////
////    @Override
////    public io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span addEvent(String name, Attributes attributes, long timestamp, TimeUnit unit) {
////        return this;
////    }
////
////    @Override
////    public io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span setStatus(StatusCode statusCode, String description) {
////        return this;
////    }
////
////    @Override
////    public io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span recordException(Throwable exception) {
////        NewRelic.noticeError(exception);
////        return this;
////    }
////
////    @Override
////    public io.opentelemetry.javaagent.shaded.io.opentelemetry.api.trace.Span recordException(Throwable exception, Attributes additionalAttributes) {
...
////    @Override
////    public void end() {
////        if (io.opentelemetry.api.trace.SpanKind.CLIENT == spanKind) {
////            reportClientSpan();
////        }
...
////
////    @Override
////    public <T> T getAttribute(io.opentelemetry.javaagent.shaded.io.opentelemetry.api.common.AttributeKey<T> attributeKey) {
////        return null;
////    }
////
