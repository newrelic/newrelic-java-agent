...
public class NRTracerBuilderTest extends TestCase {
    final TracerSharedState TRACER_SHARED_STATE = new TracerSharedState(Clock.getDefault(), IdGenerator.random(),
            Resource.empty(), SpanLimits::getDefault, Sampler.alwaysOn(), Collections.emptyList(), ExceptionAttributeResolver.getDefault(),
            new SdkTracerInstrumentation(MeterProvider::noop));
