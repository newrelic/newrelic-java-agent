...
@InstrumentationTestConfig(includePrefixes = { "com.nr.agent.instrumentation.play28", "play" })
public class ServerInstrumentationTest {
    ...
    public void testControllerActions() {
        given()
                .baseUri("http://localhost:" + playApplicationServerRule.getTestServer().getRunningHttpPort().getAsInt())
                .when()
                .get("/hello")
                .then()
