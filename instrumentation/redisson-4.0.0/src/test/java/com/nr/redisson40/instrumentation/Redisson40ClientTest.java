...
public class Redisson40ClientTest {
	...
	public void dequeReactiveTest() {
		...
		String txnName = "OtherTransaction/Custom/com.nr.redisson40.instrumentation.Redisson40ClientTest/testDequeReactive";
	...
	public void queueTest() {
		...
		Collection<String> txnNames = introspector.getTransactionNames();
		String txnName = "OtherTransaction/Custom/com.nr.redisson40.instrumentation.Redisson40ClientTest/testQueue";
		assertTrue(txnNames.contains(txnName));
		Map<String, TracedMetricData> metrics = introspector.getMetricsForTransaction(txnName);
	...
	public void bucketTest() {
		...
		Collection<String> txnNames = introspector.getTransactionNames();
		String txnName = "OtherTransaction/Custom/com.nr.redisson40.instrumentation.Redisson40ClientTest/testBucket";
		assertTrue(txnNames.contains(txnName));
		Map<String, TracedMetricData> metrics = introspector.getMetricsForTransaction(txnName);
	...
	public void batchTest() {
		...
		Collection<String> txnNames = introspector.getTransactionNames();
		String txnName = "OtherTransaction/Custom/com.nr.redisson40.instrumentation.Redisson40ClientTest/testBatch";
		assertTrue(txnNames.contains(txnName));
