...
public abstract class HttpShardHandler_Instrumentation {
    ...
    public void submit(final ShardRequest sreq, final String shard, final ModifiableSolrParams params, String preferredHostAddress) {
        ...
        AgentBridge.getAgent().getLogger().log(Level.FINEST, "HttpShardHandler submit sreq={0}, shard={1}, params={2}, preferred host={3}",
                sreq, shard, params, preferredHostAddress);
    }
