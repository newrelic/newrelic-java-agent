...
@Weave(type = MatchType.BaseClass, originalName = "org.springframework.boot.webmvc.actuate.endpoint.web.AbstractWebMvcEndpointHandlerMapping")
public class AbstractWebMvcEndpointHandlerMapping_Instrumentation {
    @Weave(type = MatchType.ExactClass, originalName = "org.springframework.boot.webmvc.actuate.endpoint.web.AbstractWebMvcEndpointHandlerMapping$OperationHandler")
