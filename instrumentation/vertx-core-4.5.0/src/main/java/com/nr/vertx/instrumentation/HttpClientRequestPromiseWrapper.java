...
public class HttpClientRequestPromiseWrapper implements PromiseInternal<HttpClientRequest> {
    ...
    @Override
    public <U> io.vertx.core.Future<U> transform(Function<AsyncResult<HttpClientRequest>, io.vertx.core.Future<U>> mapper) {
        return original.transform(mapper);
    }

    @Override
    public <U> io.vertx.core.Future<HttpClientRequest> eventually(Function<Void, io.vertx.core.Future<U>> mapper) {
    ...
    @Override
    public io.vertx.core.Future<HttpClientRequest> timeout(long l, TimeUnit timeUnit) {
        return original.timeout(l, timeUnit);
    }
}
