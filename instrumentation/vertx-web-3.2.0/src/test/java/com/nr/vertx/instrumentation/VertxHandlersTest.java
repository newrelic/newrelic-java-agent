...
public class VertxHandlersTest extends VertxTestBase {
    ...
    public void testSerialRequestHandlers() {
        ...
        try {
            ...
            getRequest(server, port).then().body(containsString("ThirdHandler sent response"));
    ...
    public void testNoErrorHandlerFail() {
        ...
        try {
            ...
            getRequest(server, port).then().statusCode(403);
    ...
    public void testNoErrorHandlerFailThrowable() {
        ...
        try {
            ...
            getRequest(server, port).then().statusCode(500);
    ...
    public void testFailureHandler() {
        ...
        try {
            ...
            getRequest(server, port).then().statusCode(530).body(containsString("It's cold here!"));
