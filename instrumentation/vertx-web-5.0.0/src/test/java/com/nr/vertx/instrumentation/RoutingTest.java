...
public class RoutingTest extends VertxTestBase{
    ...
    public void testSubRouters() {
        ...
        try {
            ...
            // In Vert.x 5.0.0, mountSubRouter was replaced by route(path).subRouter(router).
            // The wildcard suffix is required; the transaction name reflects the matching path pattern.
            mainRouter.route("/api/*").subRouter(helloRouter);
