...
public class JavaVersionUtilsTest {
    ...
    public void javaVersionHigherThanSupported() {
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21+181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0+181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0_b181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0.1"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0.1+11"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0.1_11"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("21.0.1_11-b11"));
    }
    ...
    public void unsupportedJavaVersionMessageWhenGreaterThanMaxSupportedVersion() {
        String msg = JavaVersionUtils.getUnsupportedAgentJavaSpecVersionMessage(JavaVersionUtils.JAVA_21);
        assertThat(msg, containsString(JavaVersionUtils.JAVA_21));
        assertThat(msg, containsString("Java greater than 20."));
    }
    ...
    public void emptyMessageReturnedWhenJavaVersionSupported() {
        ...
        msg = JavaVersionUtils.getUnsupportedAgentJavaSpecVersionMessage(JavaVersionUtils.JAVA_20);
        assertEquals(0, msg.length());
