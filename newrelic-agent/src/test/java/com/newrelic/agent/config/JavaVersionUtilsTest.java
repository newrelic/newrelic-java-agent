...
public class JavaVersionUtilsTest {
    ...
    public static final String JAVA_28 = "28";
    ...
    public void supportAgentJavaSpecVersions() {
        ...
        assertTrue(JavaVersionUtils.isAgentSupportedJavaSpecVersion(JAVA_27));
    }
    ...
    public void javaVersionHigherThanSupported() {
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28."));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28+181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0+181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0_b181"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0.1"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0.1+11"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0.1_11"));
        assertFalse(JavaVersionUtils.isAgentSupportedJavaSpecVersion("28.0.1_11-b11"));
    }
    ...
    public void unsupportedJavaVersionMessageWhenGreaterThanMaxSupportedVersion() {
        String msg = JavaVersionUtils.getUnsupportedAgentJavaSpecVersionMessage(JAVA_28);
        assertThat(msg, containsString(JAVA_28));
        assertThat(msg, containsString("Java greater than 27."));
    }
    ...
    public void emptyMessageReturnedWhenJavaVersionSupported() {
        ...
        msg = JavaVersionUtils.getUnsupportedAgentJavaSpecVersionMessage(JAVA_27);
        assertEquals(0, msg.length());
