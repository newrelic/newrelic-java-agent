...
PublishConfig.config(
    ...
    artifactId = "newrelic-opentelemetry-span-processor-agent-extension"
    artifact(shadowJar)
    artifact(javadocJar)
    artifact(sourcesJar)
...
var openTelemetryInstrumentationVersion = "2.13.3-alpha"
...
//    implementation("io.opentelemetry.instrumentation:opentelemetry-instrumentation-bom:2.12.0")
//    implementation("io.opentelemetry.javaagent:opentelemetry-javaagent:2.12.0")
